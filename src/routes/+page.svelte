            ...
            <div class="row">
                <div class="col-xl-7 py-xl-5">
                    <div class="container auto py-5 px-md-5">
                        <div class="text-white py-xl-4"><b>Discover Dellcious Recipes</b> - 맛있는 요리법을 발견하세요.</div>
                            ...
                            <div class="modal-content rounded-4 shadow">
                                ...
                                <div class="modal-body p-5 pt-0">
                                    <form on:submit|preventDefault>
                                        ...
                                        <button class="w-100 mb-2 btn btn-lg rounded-3 btn-primary-cust" type="button">Sign up</button>
                                        <small class="text-body-secondary">By clicking Sign up, you agree to the terms of use.</small>
                                        <div class="py-2 mb-3 form-check d-flex">
                                            <input type="checkbox" class="form-check-input" id="floatingCheck">
                                            <label class="form-check-label px-2" for="floatingCheck">로그인 정보 저장</label>
                                            <a class="ms-auto text-decoration-none px-2 a-hover" href="#">회원가입</a>
                                        </div>
                                        <hr class="my-4">
                                        <h2 class="fs-5 fw-bold mb-3">다른 방식으로 로그인</h2>
                                        
                                        <button class="w-100 py-2 mb-2 btn btn-outline-primary rounded-3" type="button" on:click={handleGoogleLogin}>
                                            <svg class="bi me-1" width="16" height="16" aria-hidden="true"><use xlink:href="#google"></use></svg>
                                            Sign up with Google
                                        </button>
                                        <button class="w-100 py-2 mb-2 btn btn-outline-github rounded-3" type="button">
                                            <svg class="bi me-1" width="16" height="16" aria-hidden="true"><use xlink:href="#github"></use></svg>
                                            Sign up with GitHub
                                        </button>
                                        <button class="w-100 py-2 mb-2 btn btn-outline-kakao rounded-3" type="button">
